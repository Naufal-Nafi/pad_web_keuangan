                ...
                <form class="space-y-4 md:space-y-6 px-10">
                    ...
                    <div class="relative bg-transparent">
                        ...
                        <input type="date" id="date" name="date"
                            class="cursor-help bg-gray-50 border pl-10 border-gray-300 text-gray-900 drop-shadow-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
