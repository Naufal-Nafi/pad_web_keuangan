...
@section('content')
    <div x-data="{ showModalTransaction: false, deleteId: null }" class="p-10">
        <!-- line chart -->
        ...
        <div class="relative overflow-x-auto drop-shadow-lg sm:rounded-lg mx-auto mt-4">
            <div class="flex items-center justify-between" style="background:#EEF0F4">
                <a href="{{ route('laporan.create') }}" class="flex items-center group ">
                    ...
                    <p class="items-center text-blue-600 group-hover:underline ms-2"
            ...
            <!-- pagination -->
            <div class="flex justify-between" style="background:#EEF0F4">
    ...
    <script>
        ...
        async function fetchConsignments(page = 1, perPage = 10, search = '') {
            const token = sessionStorage.getItem('auth_token');
            const url = new URL(`/api/consignment`, window.location.origin);
        ...
        const debouncedSearch = debounce((e) => {
            ...
            fetchConsignments(1, currentPerPage, keyword);
        }, 500); // tunggu 500ms
