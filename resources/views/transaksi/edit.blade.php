                ...
                <form class="space-y-4 md:space-y-6 px-10" method="POST">
                    ...
                    <div class="relative bg-transparent">
                        ...
                        <input type="date" name="entry_date" id="entry_date"
                            class="cursor-help pl-10 bg-gray-50 border border-gray-300 text-gray-900 drop-shadow-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            title="Masukkan tanggal masuk">
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            form.addEventListener('submit', async function (e) {
                ...
                try {
                    const response = await fetch(`/api/consignment/update/${id}`, {
