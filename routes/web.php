...
Route::prefix('transaksi')->group(function () {
    Route::get('/', function (){ return view('transaksi.transaksi'); })->name('transaksi');
    Route::get('/tambah', function () {return view('transaksi.tambah'); })->name('laporan.create');
    Route::get('/edit/{consignment_id}', function () { return view('transaksi.edit'); })->name('laporan.edit');
});
